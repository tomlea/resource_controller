...
...or if you need to inherit from some other class:

  class PostsController < ResourceController::Base(AdminController)
  end

...or if you prefer, you can use the method-call syntax.:
